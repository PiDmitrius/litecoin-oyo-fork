...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-oyo", "Enable OYO wallet RPC extensions and wallet compatibility behavior (default: 1). Use -nooyo for vanilla-compatible behavior.", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
